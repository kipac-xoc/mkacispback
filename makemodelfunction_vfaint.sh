...
if [ "${CCD}" -eq 0 ];then AVERATE=0.15; ALPHA=0.1; fi
if [ "${CCD}" -eq 1 ];then AVERATE=0.15; ALPHA=0.1; CCD1FAC=0.90; fi
if [ "${CCD}" -eq 2 ];then AVERATE=0.20; ALPHA=0.2; fi
if [ "${CCD}" -eq 3 ];then AVERATE=0.15; ALPHA=0.15; fi
if [ "${CCD}" -eq 5 ];then AVERATE=1.70; ALPHA=0.2; fi
if [ "${CCD}" -eq 6 ];then AVERATE=0.25; ALPHA=0.1; fi
if [ "${CCD}" -eq 7 ];then AVERATE=0.95; ALPHA=0.5; fi
...
if [ "${LINE_NO}" -eq 72 ]; then LINE1_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
...
if [ "${LINE_NO}" -eq 77 ]; then PL_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
...
if [ "${LINE_NO}" -eq 86 ]; then LINE2_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 87 ]; then LINE3_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 88 ]; then LINE3_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 89 ]; then LINE3_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
...
if [ "${LINE_NO}" -eq 74 ]; then G1_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 75 ]; then G2_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 76 ]; then G2_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 77 ]; then G2_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 78 ]; then G3_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 79 ]; then G3_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 80 ]; then G3_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 81 ]; then G4_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 82 ]; then G4_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 83 ]; then G4_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 84 ]; then G5_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 85 ]; then G5_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 86 ]; then G5_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 87 ]; then G6_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 88 ]; then G6_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 89 ]; then G6_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 90 ]; then G7_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 91 ]; then G7_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 92 ]; then G7_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 93 ]; then G8_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 94 ]; then G8_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 95 ]; then G8_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 96 ]; then G9_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 97 ]; then G9_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 98 ]; then G9_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 99 ]; then G10_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 100 ]; then G10_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 101 ]; then G10_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 102 ]; then G11_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 103 ]; then G11_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 104 ]; then G11_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 105 ]; then G12_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 106 ]; then G12_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 107 ]; then G12_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 108 ]; then G13_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 109 ]; then G13_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 110 ]; then G13_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
...
if [ "${LINE_NO}" -eq 90 ]; then G7_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 91 ]; then G8_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 92 ]; then G8_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 93 ]; then G8_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
...
if [ "${LINE_NO}" -eq 100 ]; then BKN_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 101 ]; then G9_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 102 ]; then G9_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 103 ]; then G9_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 104 ]; then G10_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 105 ]; then G10_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 106 ]; then G10_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
if [ "${LINE_NO}" -eq 107 ]; then G11_E+=( $VAL ); fi
if [ "${LINE_NO}" -eq 108 ]; then G11_S+=( $VAL ); fi
if [ "${LINE_NO}" -eq 109 ]; then G11_N+=( `perl -e "print ${VAL}*${WEIGHT[$(( MOD_NO-1 ))]}"` ); fi
